...
// source: seedchain/seedchain/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_42e676849c344bf8, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_42e676849c344bf8, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "seedchain.seedchain.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "seedchain.seedchain.QueryParamsResponse")
}

func init() { proto.RegisterFile("seedchain/seedchain/query.proto", fileDescriptor_42e676849c344bf8) }

var fileDescriptor_42e676849c344bf8 = []byte{
	// 282 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2f, 0x4e, 0x4d, 0x4d,
	...
	0xff, 0xff, 0x7e, 0x96, 0x7b, 0x0a, 0xec, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/seedchain.seedchain.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/seedchain.seedchain.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "seedchain.seedchain.Query",
	...
	Metadata: "seedchain/seedchain/query.proto",
}
